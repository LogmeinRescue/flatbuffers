...
std::string GenStringOffsetType() {
  if(lang_.language == IDLOptions::kCSharp) {
    return "StringOffset";
  } else {
    return "int";
...
std::string GenMembersForUnion(EnumDef &enum_def, std::string postFix) {
  std::string code = "";
...
std::string GenGetUnionTypeByteMethodName() {
